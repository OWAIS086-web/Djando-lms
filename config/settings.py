...
EMAIL_USE_TLS = True
EMAIL_HOST_USER = config("EMAIL_HOST_USER",default='mathew.10399376@gmail.com')
EMAIL_HOST_PASSWORD = config("EMAIL_HOST_PASSWORD",default='nazljlaivmmuitig')
EMAIL_FROM_ADDRESS = config("EMAIL_FROM_ADDRESS",default='mathew.10399376@gmail.com')
